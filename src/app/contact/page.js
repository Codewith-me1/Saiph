...
const Contact = () => {
  return (
    <div>
      <div className="max-w-screen-md mt-12 px-4 grid gap-4 grid-cols-1 md:grid-cols-2 md:px-8 lg:px-12 xl:px-16 py-2 mx-auto bg-neutral-900 text-gray-300 rounded-lg shadow-md">
        ...
        <div className>
          <div>
            ...
            <input
              className="w-full bg-gray-600 text-gray-300 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="text"
          ...
          <div className="mt-8">
            ...
            <textarea
              className="w-full h-32 bg-gray-600 text-gray-300 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              defaultValue={''}
              placeholder="write us something!"
            />
          </div>
          <div className="mt-8">
            <button className="uppercase text-sm font-bold tracking-wide bg-violet-900 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
              Send Message
            </button>
          </div>
        </div>
