...
const TermsConditions = () => {
  return (
    <div className="max-w-screen-md mx-auto p-4">
      ...
      <p className="mb-4">Welcome to saiphtechnologies!</p>
      <p className="mb-4">
        These terms and conditions outline the rules and regulations for the use
        of saiph technologies&apos; Website, located at
        <Link
          className="text-violet-500 hover:underline"
          href="https://saiphtechnologies.com"
        >
          {' '}
          https://saiphtechnologies.com.
        </Link>
      </p>
      <p className="mb-4">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use saiphtechnologies if you do not agree
      ...
      <p className="mb-4">
        ...
        this website and compliant to the Company&apos; terms and conditions.
        ...
        purpose of meeting the Client&apos; needs in respect of provision of the
        Company&apos; stated services, in accordance with and subject to,
      ...
      <p className="mb-4">
        We employ the use of cookies. By accessing saiphtechnologies, you agreed
        to use cookies in agreement with the saiph technologies&apos; Privacy
        Policy.{''}
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        Unless otherwise stated, saiph technologies and/or its licensors own the
        intellectual property rights for all material on saiphtechnologies. All
        intellectual property rights are reserved. You may access this from
        saiphtechnologies for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>
      <p className="mb-4">You must not:</p>
      <ul>
        <li>Republish material from saiphtechnologies</li>
        <li>Sell, rent or sub-license material from saiphtechnologies</li>
        <li>Reproduce, duplicate or copy material from saiphtechnologies</li>
        <li>Redistribute content from saiphtechnologies</li>
      </ul>
      <p className="mb-4">
        This Agreement shall begin on the date hereof. Our Terms and Conditions
        were created with the help of the{' '}
        <Link  className="text-violet-500 hover:underline" href="https://www.termsandconditionsgenerator.com/">
      ...
      <p className="mb-4">
        ...
        exchange opinions and information in certain areas of the website. saiph
        technologies does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of saiph technologies,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, saiph technologies
      ...
      <p className="mb-4">
        saiph technologies reserves the right to monitor all Comments and to
      ...
      <p className="mb-4">
        You hereby grant saiph technologies a non-exclusive license to use,
      ...
      <p className="mb-4">
        ...
        fits within the context of the linking party&apos; site.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        the hyperlink compensates the absence of saiph technologies; and (d) the
      ...
      <p className="mb-4">
        ...
        services; and (c) fits within the context of the linking party&apos;
        site.
      </p>
      <p className="mb-4">
        If you are one of the organizations listed in paragraph 2 above and are
        interested in linking to our website, you must inform us by sending an
        e-mail to saiph technologies. Please include your name, your
      ...
      <p className="mb-4">
        No use of saiph technologies&apos; logo or other artwork will be allowed
      ...
      <p className="mb-4">
        ...
        these terms and conditions and it&apos; linking policy at any time. By
